...
import { SendDiscordDMSchema } from "./schema";

export const sendDiscordDMAction = authAction
	.inputSchema(SendDiscordDMSchema)
	.action(async ({ parsedInput: { accountId, message, embed }, ctx }) => {
		try {
