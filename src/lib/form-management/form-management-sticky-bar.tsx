			...
			<AnimatePresence>
				{isShow ? (
					<motion.div
						...
						className="bg-card shadow-background pointer-events-auto flex w-full max-w-md items-center gap-2 rounded-lg border py-1 pr-2 pl-4 shadow-2xl lg:py-2"
					>
